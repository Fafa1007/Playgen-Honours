            ...
            case(3):
                switch (sprite) {
                    ...
                    case MUSHROOM:
                        return OBS_MUSHROOM;
                    case LIFE_MUSHROOM:
                        return OBS_LIFE_MUSHROOM;
                    case FIRE_FLOWER:
                        return OBS_FIRE_FLOWER;
                    case BULLET_BILL:
                        return OBS_BULLET_BILL;
                    case SHELL:
                        return OBS_SHELL;
                    case GOOMBA:
                        return OBS_GOOMBA;
                    case GOOMBA_WINGED:
                        return OBS_GOOMBA_WINGED;
                    case GREEN_KOOPA:
                        return OBS_GREEN_KOOPA;
                    case GREEN_KOOPA_WINGED:
                        return OBS_GREEN_KOOPA_WINGED;
                    case RED_KOOPA:
                        return OBS_RED_KOOPA;
                    case RED_KOOPA_WINGED:
                        return OBS_RED_KOOPA_WINGED;
                    case SPIKY:
                        return OBS_SPIKY;
                    case SPIKY_WINGED:
                        return OBS_SPIKY_WINGED;
                    case ENEMY_FLOWER:
                        return OBS_ENEMY_FLOWER;
                default:
                    return OBS_NONE;
                }
        }
    ...
    public void advance(boolean[] actions) {
        ...
        for (MarioEvent e : this.world.lastFrameEvents) {
            ...
            if (e.getEventType() == EventType.BUMP.getValue() &&
                e.getEventParam() == OBS_BRICK &&
                e.getMarioState() > 0) {
                this.breakBlock = 1;
            }
        }
    }
    public int getFallKill() {
        return fallKill;
    }

    public int getStompKill() {
        return stompKill;
    }

    public int getFireKill() {
        return fireKill;
    }

    public int getShellKill() {
        return shellKill;
    }
